...
<div class="container my-5 mx-auto">
	...
	<form method="post" class=" col-sm-5 mx-auto"
		action="adminJFerieRttEmp">
		<div class="form-group row">
			...
			<div class="text-info mx-auto">
				<p id="texteDateDebut">La date de début de congé ne peut être
					inférieur à demain</p>
			</div>
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-sm-7">
				<input type="text" class="form-control" name="selectedMotif"
					id="commentaire">
			</div>
			<div class="text-info mx-auto">
				<p id="texteMotif">Le motif est obligatoire pour les jours
					feriés</p>
			</div>
		</div>
		...
		<div>
			<p class="text-info text-center">Vos congés se chevauchent avec
				des congés existants, merci de vérifier les dates !
			<p>
		</div>
